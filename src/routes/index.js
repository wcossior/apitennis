...
const { getTorneos, getCategorias, getCuadros, getGrupos, getPartidosCuadro, getPartidosGrupo, updatePartidos, login, newUser, getProg, getTorneo, newMessage, getSets, newSet, updateSet } = require("../controllers/index.controller");
